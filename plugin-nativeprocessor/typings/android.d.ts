            ...
            export namespace CustomImageAnalysisCallback {
                export namespace Companion {
                    ...
                    function cropDocument(
                        ...
                        quads: string,
                        callback: com.akylas.documentscanner.utils.FunctionCallback,
                        transforms: string,
                        saveInFolder: string,
                        fileName: string
                    ): void;
                    ...
                    function ocrDocument(
                        ...
                        callback: com.akylas.documentscanner.utils.FunctionCallback,
                        options: string,
                        progress: com.akylas.documentscanner.CustomImageAnalysisCallback.FunctionCallbackProgress
                    ): void;
                    ...
                    function getJSONDocumentCorners(
                        image: globalAndroid.graphics.Bitmap,
                        callback: com.akylas.documentscanner.utils.FunctionCallback,
                    ...
                    function getColorPaletteFromFile(
                        context: globalAndroid.content.Context,
                        src: string,
                        callback: com.akylas.documentscanner.utils.FunctionCallback,
                        shrunkImageHeight: number,
                    ...
                    function ocrDocumentSync(
                        this_: globalAndroid.graphics.Bitmap,
                        bitmap: com.akylas.documentscanner.utils.FunctionCallback,
                        callback: string,
                        options: com.akylas.documentscanner.CustomImageAnalysisCallback.FunctionCallbackProgress
                    ): void;
                    function getColorPalette(
                        image: globalAndroid.graphics.Bitmap,
                        callback: com.akylas.documentscanner.utils.FunctionCallback,
                    ...
                    function getJSONDocumentCornersFromFile(
                        context: globalAndroid.content.Context,
                        src: string,
                        callback: com.akylas.documentscanner.utils.FunctionCallback,
                        shrunkImageHeight: number,
                ...
                export class OnQRCode extends java.lang.Object {
                     ...
                     */
                    public constructor(implementation: { onQRCodes(param0: string): void });
                    public constructor();
                ...
                export namespace ImageUtil {
                    export namespace Companion {
                        ...
                        function readBitmapFromFile(
                            resolver: globalAndroid.content.Context,
                            matrix: string,
                            rotationAngle: com.akylas.documentscanner.utils.ImageUtil.LoadImageOptions,
                            opts: any
