declare class SSZipArchive extends NSObject {
    ...
    static createZipFileAtPathWithContentsOfDirectoryKeepParentDirectoryCompressionLevelPasswordAESProgressHandler(
        path: string,
    ...
    static createZipFileAtPathWithContentsOfDirectoryKeepParentDirectoryWithPasswordAndProgressHandler(
        path: string,
        directoryPath: string,
        keepParentDirectory: boolean,
        password: string,
    ...
    static createZipFileAtPathWithFilesAtPathsWithPasswordProgressHandler(
        path: string,
        paths: NSArray<string> | string[],
        password: string,
        progressHandler: (p1: number, p2: number) => void
    ): boolean;
    ...
    static unzipFileAtPathToDestinationOverwritePasswordErrorDelegate(
        path: string,
        destination: string,
        overwrite: boolean,
        password: string,
    ...
    static unzipFileAtPathToDestinationOverwritePasswordProgressHandlerCompletionHandler(
        path: string,
        destination: string,
        overwrite: boolean,
        password: string,
        progressHandler: (p1: string, p2: unz_file_info, p3: number, p4: number) => void,
        completionHandler: (p1: string, p2: boolean, p3: NSError) => void
    ): boolean;
    ...
    static unzipFileAtPathToDestinationPreserveAttributesOverwritePasswordErrorDelegate(
        path: string,
        destination: string,
        preserveAttributes: boolean,
        overwrite: boolean,
    ...
    static unzipFileAtPathToDestinationProgressHandlerCompletionHandler(
        path: string,
        destination: string,
        progressHandler: (p1: string, p2: unz_file_info, p3: number, p4: number) => void,
        completionHandler: (p1: string, p2: boolean, p3: NSError) => void
